...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    let list = common_vendor.computed(() => store.state.shopcart.cart);
    let address = common_vendor.ref();
    let curTime = common_vendor.ref("");
    let shop = common_vendor.ref("");
    let shopId = common_vendor.ref("");
    let remark = common_vendor.computed(() => store.state.shopcart.remark);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/Study/myWork/eleme_01_uniapp/subpkg/shopOrder/shopOrder.vue"]]);
